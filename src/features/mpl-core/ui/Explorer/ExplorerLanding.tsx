import { useFetchAssetsByOwner } from '@/features/mpl-core/ui/Explorer/use-fetch-assets-by-owner.tsx'
    ...
    <Stack mt="lg">
      ...
      {isPending ? (
        ...
        <Center h="20vh" ta="center">
          <Text>There was an error fetching your Core assets.</Text>
        </Center>
      ) : assets?.length ? (
        <SimpleGrid
          cols={{
        ...
        <Center h="20vh" ta="center">
          <Text>You don&apos;t have any Core assets.</Text>
        </Center>
      )}
