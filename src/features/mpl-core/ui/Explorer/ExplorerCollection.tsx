...
import { useFetchAssetsByCollection } from '../../data-access/fetch'
      ...
      <Stack>
        ...
        {isPending ? (
          ...
          <Center h="20vh" ta="center">
            <Text>There was an error fetching assets in this collection.</Text>
          </Center>
        ) : assets?.length ? (
          <SimpleGrid
            cols={{
          ...
          <Center h="20vh" ta="center">
            <Text>This collection does not have any assets.</Text>
          </Center>
        )}
      </Stack>
    </>
